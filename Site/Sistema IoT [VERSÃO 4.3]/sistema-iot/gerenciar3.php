	...
	<div class="navbar">
		...
		<ul class="navbar-nav nav-right">
			...
			<li class="nav-item mode">
				<a class="nav-link">
					<span>
						<?php echo "Medições energéticas em $dataChart"; ?>
					</span>
				</a>
			</li>
	...
	<div class="sidebar">
		<ul class="sidebar-nav">
			<li class="sidebar-nav-item">
				<a href="dashboard3.php" class="sidebar-nav-link ">
					<div>
			...
			<li class="sidebar-nav-item">
				<a href="relatorios3.php" class="sidebar-nav-link">
					<div>
		...
		<div class="row">
			<div class="col-3 col-m-6 col-sm-6">
				<div class="counter bg-success">
					<form>
						<label>
							<h3>Limpar dados coletados em <?php echo $dataChart; ?></h3>
						</label>
						<input type="button" value="Limpar" onclick=excluirItens()>
						<script>
							function excluirItens() {
								var resultado = confirm("Deseja excluir a leitura?");
								if (resultado == true) {
									window.location.href = "excluir3.php";
									alert("Leitura excluída!");
								} else {
									alert("A leitura NÃO foi excluída");
								}
							}
						</script>
					</form>
